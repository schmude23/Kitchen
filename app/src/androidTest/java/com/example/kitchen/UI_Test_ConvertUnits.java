...
public class UI_Test_ConvertUnits {
    ...
    public void uI_Test_ConvertUnits() {
        ...
        ViewInteraction appCompatSpinner = onView(
                allOf(withId(R.id.unit_conversion_popup_old_unit_spinner),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withId(android.R.id.text1), withText("butter [ 12.0 teaspoon(s) ]"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("butter [ 12.0 teaspoon(s) ]")));
    }
